...
import { companyProfiles } from "@/mocks/companyProfiles";
import { companyProfilesExtra } from "@/mocks/companyProfilesExtra";
import { profilesByRisk } from "@/mocks/profilesByRisk";
import type {
  Company,
  CompanyProfile,
  TimelineImpact,
